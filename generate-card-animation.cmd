...
echo.
echo Examples:
echo   generate-card-animation.cmd AFR "Improvised Weaponry" "clip.mp4" 150
...
echo   generate-card-animation.cmd FDN "Burst Lightning" "burst.mp4" 192
echo.
echo Options:
echo   --number 372     Card / collector number [required]
...
echo   --yes            Skip the target confirmation prompt
echo.
echo ====================================================================
pause
exit /b 1
