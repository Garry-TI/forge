            ...
            if (!loaded) {
                ...
                if (subFolders != null) {
                    for (File sub : subFolders) {
                        ...
                        if (animationFiles.containsKey(setCardSlash)) {
                            File[] f = animationFiles.get(setCardSlash);
                            animationFiles.putIfAbsent(subName, f);
                            animationFiles.putIfAbsent(subNorm, f);
                        }
                    }
                }
            }
